...
const helloblocks = [
  {
    ...
    text: {
      type: "mrkdwn",
      text:
        "Hey there 👋 I'm DEVBot. I'm here to help you fetch articles from DEV.to directly to Slack.",
    },
  },
  { type: "divider" },
  {
  ...
  },
  {
    ...
    text: {
      type: "mrkdwn",
      text:
        "*Some tag sugggestions are *. react , python , javascript , webdev , blockchain , career , css , node , productivity , devops , go , ai , ux , ionic , firebase etc.",
    },
  },
  ...
  { type: "divider" },
  {
    ...
    text: {
      type: "mrkdwn",
      text:
        "➕ To start searching, *add me to a channel* and I'll introduce myself. ",
    },
  },
];
